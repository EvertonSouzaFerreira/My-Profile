...
export const getProjetos = (type: string) => {
    switch (type) {
      ...
      case "ProjetoTodo":
        return {message: 'Este e um Todo List que podemos nao somente adcionar novos itens ou apagar e possivel tambem aditar mostras somente os que forao feitos e muito mais', tela: telaProjetoTodo, link: 'https://zen-snyder-8ce041.netlify.app'};
      case "ProjetoLivro":
