  ...
  return (
    <ContainerAbout>
        ...
        <DescricaoFoto>
            ...
            <p><span>const </span> <span style={{color: '#80c9f9'}}>cursos</span> = [<span style={{color: '#E99287'}}>Bootcamp Desenvolvimento Web Full-Stack, JavaScript full-stack, Advanced CSS and Sass, ReactJS  </span>];</p>
            </div>:
            ...
            <p><span>const </span> <span style={{color: '#80c9f9'}}>Additional Courses</span> = [<span style={{color: '#E99287'}}>Bootcamp Desenvolvimento Web Full-Stack, JavaScript full-stack, Advanced CSS and Sass, ReactJS  </span>];</p>
            </div>}
